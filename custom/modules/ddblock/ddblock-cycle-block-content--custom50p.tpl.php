...
/*!
 * Dynamic display block module template (Drupal 7): custom50p - content template
...
<div id="ddblock-<?php print $settings['delta'] ?>" class="ddblock-cycle-<?php print $settings['template'] ?> clearfix">
 ...
 <div class="tcont"><?php print $slider_item['node_idtc'] ?></div>
            ...
            <?php if (isset($slider_item['slide_text'])) :?>
             <div class="slide-body-<?php print $settings['slide_direction'] ?> clearfix">
              <div class="slide-body-inner clearfix">
               ...
               <p><?php print $slider_item['subt2'] ?></p>
               <p><?php print $slider_item['subt3'] ?></p>	
               <p><?php print $slider_item['subt4'] ?></p>
               </div>
              </div> <!-- slide-body-inner-->
              </div>  <!-- slide-body-->
              <div class="fecha"><?php print $slider_item['post_date'] ?></div>
